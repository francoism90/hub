...
class Video extends Model implements HasMedia
{
    ...
    public function toSearchableArray(): array
    {
        return [
            ...
            'studios' => (array) $this->tags->type(TagType::studio())->seo(),
            'people' => (array) $this->tags->type(TagType::person())->seo(),
            'genres' => (array) $this->tags->type(TagType::genre())->seo(),
            'languages' => (array) $this->tags->type(TagType::language())->seo(),
